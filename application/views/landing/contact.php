...
<html>
<head>
<title>Heaped a Corporate Business Category Flat Bootstrap Responsive Website Template | Contact :: W3layouts</title>
	...
	<div class="header">
      ...
      <div class="container">
        <div class="navbar-header">
         ...
         <a class="navbar-brand" href="index.html">Heaped</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav">
						<li><a href="about.html" class="hover-effect scroll">
								<span>
									<span>ABOUT</span>
									<span>ABOUT</span>
									<span></span>
						...
						<li><a href="services.html" class="hover-effect scroll">
								<span>
									<span>SERVICES</span>
									<span>SERVICES</span>
									<span></span>
						...
						<li><a href="gallery.html" class="hover-effect scroll">
								<span>
									<span>GALLERY</span>
									<span>GALLERY</span>
									<span></span>
						...
						<li><a href="codes.html" class="hover-effect scroll">
								<span>
									<span>CODES</span>
									<span>CODES</span>
									<span></span>
						...
						<li><a href="contact.html" class="hover-effect scroll">
								<span>
									<span>CONTACT</span>
									<span>CONTACT</span>
									<span></span>
	...
	<div class="contact agileinfo">
		<div class="container">
			...
			<div class="col-md-6 col-sm-6 cr  agileinfo-2">
				<h4>OUR ADDRESS:</h4>
				<h5>7th Isum Road,   <br>Sydney City, <br>Australia.</h5>
				<h4> Phone:</h4>
				<h5>+598 256 9850</h5>
				<h4>E-mail:</h4>
	...
	<div class="footer agileits">
		<div class="container">
			<div class="footer-bottom">
				...
				<div class="col-md-3 footer-grids footer-mdl w3agile">
				<h4>Follow Us</h4>
					<div class="social">
						<ul>
				...
				<div class="col-md-5 footer-grids agileinfo">
				<h4>Contact Info</h4>
